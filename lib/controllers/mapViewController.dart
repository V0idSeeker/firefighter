...
class MapViewController extends GetxController {
  ...
  MapViewController(this.firefighter);
  ...
  Future<void> markRespondent() async {
    ...
    else mapOptions=MapOptions(center : currentPosition, zoom: 15);
  }
  moveMap(LatLng pos){
    mapController.move(pos, 15  );
  }

  Future<bool> updateFireStatus( int fireId, String newStatus)async{
    return await db.updateFireStatus(fireId, firefighter.personId, newStatus);
  }
